...
\end{tabularx}
\endgroup
\caption{\textbf{LIBERO-Plus robustness.} Success percentages across seven perturbation axes; the mean retains the source aggregation. Source: \refsource{}. \benchmarknote}
