...
\jamshade\textbf{JAM} & \estimate{86.0} & \estimate{88.5} & \estimate{92.0} & \estimate{97.5} & \estimate{94.5} & \estimate{86.0} & \estimate{90.5} & \estimate{90.2} \\
\bottomrule
\end{tabularx}
\endgroup
\caption{\textbf{LIBERO-Plus robustness.} Success percentages across seven perturbation axes. External means retain their source aggregation; JAM uses task-count weights. Source: \refsource{}. Bold marks external column maxima; NR means unreported.\newline\emph{\estimatebenchmarknote}}
