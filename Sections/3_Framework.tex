...
\begin{tikzpicture}[font=\scriptsize,
  ...
  cpt/.style={font=\scriptsize, align=center, text=black!70}]

% ---------- panel A: single system ----------
\begin{scope}[shift={(0,0)}]
  \foreach \i in {0,1,2,3} { \node[vb] (a\i) at (0, \i*0.62) {}; }
  \node[ab, minimum width=9mm] (atok) at (0,-0.78) {};
  \node[cpt] at (0,-1.60) {action and state\\tokens in sequence};
  \node[ttl] at (0,2.92) {(a) single system};
  \node[cpt, anchor=west] at (0.62,1.86) {shared\\blocks};
...
\begin{scope}[shift={(4.2,0)}]
  ...
  \node[cpt] at (0.3,-1.60) {expert feed-forward\\on the action segment};
...
\begin{scope}[shift={(8.6,0)}]
  ...
  \node[cpt] at (0.75,-0.95) {one mixed attention\\at every layer};
...
\begin{scope}[shift={(0,-6.2)}]
  ...
  \node[cpt] at (0.75,-0.95) {video completes, then\\action reads the bridge};
...
\begin{scope}[shift={(4.6,-6.2)}]
  ...
  \node[cpt] at (0,-0.95) {noisy};
  \node[cpt] at (1.35,-0.95) {condition};
  \node[cpt] at (2.7,-0.95) {action};
...
\begin{scope}[shift={(10.2,-6.2)}]
  ...
  \node[cpt] at (1.4,-0.95) {frozen understanding\\tokens as a read-only tail};
...
\begin{tikzpicture}[font=\scriptsize, x=1mm, y=1mm,
  ...
  onst/.style={fill=tianzhegreen!45},
  offst/.style={fill=black!6},
  halfst/.style={fill=tianzheblue!32}]
