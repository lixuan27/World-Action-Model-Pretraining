...
Measured logs, external references, layout targets, and benchmark estimates occupy separate artifact files. The README gives the complete build procedure. The commands \texttt{python3} \path{scripts/build_artifacts.py} and \texttt{python3} \path{scripts/validate.py} regenerate the numerical displays and check evidence consistency, respectively.
