...
EgoDex \citep{egodex}; The active caches contain 1,674,648 DROID, 454,690 Bridge, and 738,550 EgoDex training windows.
Sampling temperature 0.7 gives source probabilities of approximately 50.9\%, 20.4\%, and 28.7\%. The cache reserves an episode-level holdout using a deterministic one-in-ten
