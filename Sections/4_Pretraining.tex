...
\citep{cadene2024lerobot} where one exists. The recipe reaches 6\,451 hours, of
which 3\,933 come from real robots, 146 from simulation, and 2\,372 from
egocentric human footage. Hours are computed from frame counts divided by verified
...
large bimanual simulation corpus, and the remainder adds egocentric diversity
and two further real platforms. Both tiers
...
suite, and it is what keeps the simulation share of the corpus small. One real source with a three hertz control rate is retained with a
...
existing adapters; tier~2 is staged from public releases. The total divides into
3\,933 hours of real robot data, 146 hours of simulation, and 2\,372 hours of
egocentric human footage, and the small simulation share follows from holding
both evaluation suites out of pretraining.}
\label{tab:corpus}
\adjustbox{max width=\linewidth}{%
